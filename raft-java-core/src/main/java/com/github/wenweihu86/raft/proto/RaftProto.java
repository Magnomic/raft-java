...
public final class RaftProto {
  ...
  public interface AppendEntriesRequestOrBuilder
    ...
    // repeated .raft.LogEntry futureEntries = 7;
    /**
     * <code>repeated .raft.LogEntry futureEntries = 7;</code>
     *
     * <pre>
  ...
  public static final class AppendEntriesRequest extends
    ...
    // repeated .raft.LogEntry futureEntries = 7;
    public static final int FUTUREENTRIES_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < futureEntries_.size(); i++) {
        output.writeMessage(7, futureEntries_.get(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < futureEntries_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, futureEntries_.get(i));
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_raft_AppendEntriesRequest_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_raft_AppendEntriesRequest_descriptor,
              new String[] { "ServerId", "Term", "PrevLogIndex", "PrevLogTerm", "CommitIndex", "Entries", "FutureEntries", });
          internal_static_raft_AppendEntriesResponse_descriptor =
